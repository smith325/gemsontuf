...
repoPath = "/home/nek/Desktop/gemsonTUF/gemsontuf/repository/"

#key generate, they're all the same kind of
print "Generating keys"
generate_and_write_rsa_keypair("root_key1",      bits=2048, password=secret_root_1)
generate_and_write_rsa_keypair("root_key2",      bits=2048, password=secret_root_2)
generate_and_write_rsa_keypair("root_key3",      bits=2048, password=secret_root_3)

generate_and_write_rsa_keypair("targets_key1",   bits=2048, password=secret_targets_1)
generate_and_write_rsa_keypair("targets_key2",   bits=2048, password=secret_targets_2)

generate_and_write_rsa_keypair("release_key1",   bits=2048, password=secret_release_1)
generate_and_write_rsa_keypair("release_key2",   bits=2048, password=secret_release_2)

generate_and_write_rsa_keypair("timestamp_key1", bits=2048, password=secret_timestamp_1)
generate_and_write_rsa_keypair("timestamp_key2", bits=2048, password=secret_timestamp_2)
